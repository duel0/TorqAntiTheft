// TESTING ACQUISIZIONE DA SENSORE CON ADC E COMUNICAZIONE A RPI
...
volatile uint8_t sensorDetected = 0;
...
void EXTI0_IRQHandler(void) {
    if (EXTI->PR & EXTI_PR_PR0) {
        EXTI->PR = EXTI_PR_PR0; // Cancella il flag di interruzione
        sensorDetected = 1;
    }
}
/* USER CODE END 0 */
...
//CONFIGURAZIONE DEL PIN DEL SENSORE A INFRAROSSI COME INPUT
  ...
  // Configurazione dei pin dei LED come output
     GPIO_InitStruct.Pin = LED3_PIN | LED10_PIN;
     GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
     GPIO_InitStruct.Pull = GPIO_NOPULL;
     GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
     HAL_GPIO_Init(LED3_PORT, &GPIO_InitStruct);

  // Abilita l'interruzione per il sensore a infrarossi
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  if (sensorDetected) {
	              ...
	              // Accendi il LED3 per un breve periodo
	              HAL_GPIO_WritePin(LED3_PORT, LED3_PIN, GPIO_PIN_SET);
	              HAL_Delay(100);
	              HAL_GPIO_WritePin(LED3_PORT, LED3_PIN, GPIO_PIN_RESET);
	          } else {
	              // Mantieni acceso il LED10
